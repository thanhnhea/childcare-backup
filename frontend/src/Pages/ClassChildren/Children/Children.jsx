...
const Children = () => {
  ...
  <Container className="mt-5 mb-4">
    <Row>
        <h1 className="display-1 mb-5 text-primary text-uppercase">Student Information</h1>
    </Row>
    <Row>
        <Col>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Junior</td>
      <td>
        <button type="button" className="btn btn-primary btn-rounded btn-sm fw-bold" data-mdb-ripple-color="dark" >
          Edit
        </button>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p className="fw-normal mb-1">Reject</p>
        <p className="text-muted mb-0">HD1</p>
      </td>
      <td>
      ...
      <td>Senior</td>
      <td>
        <button type="button" className="btn btn-primary btn-rounded btn-sm fw-bold" data-mdb-ripple-color="dark" > Edit </button>
      </td>
    </tr>
  </tbody>
</table>
