        ...
        <Col lg={6} md={5}  className="d-none d-xl-block text-center">
          ...
          <Col lg={6} md={7}>
            <div className="my-5 text-center text-xl-start">
              <h1 className="display-5 fw-bolder text-warning mb-2">Huong Duong 1</h1>
        ...
        <Row className="row gx-5">
          <Col lg={4} className="mb-5">
            <div className="card h-100 shadow border-0">
              ...
              <div className="card-body p-4">
                ...
                <a className="text-decoration-none link-dark stretched-link" href="#!"><h5 class="card-title mb-3">Huong Duong Awards</h5></a>
          ...
          <Col lg={4} className=" mb-5">
            <div className="card h-100 shadow border-0">
              ...
              <div className="card-body p-4">
                ...
                <a className="text-decoration-none link-dark stretched-link" href="#!"><h5 class="card-title mb-3">Huong Duong Happy</h5></a>
          ...
          <Col lg={4} className="mb-5">
            <div className="card h-100 shadow border-0">
              ...
              <div className="card-body p-4">
                <div className="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                <a className="text-decoration-none link-dark stretched-link" href="#!"><h5 class="card-title mb-3">Huong Duong Lucky</h5></a>
                ...
                <div className="d-flex align-items-end justify-content-between">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="small">
                      ...
                      <div clclassNameass="text-muted">April 2, 2023 &middot; 10 min read</div>
                    </div>
                  </div>
                </div>
              </div>
